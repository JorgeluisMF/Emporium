...
{
    public class ProductCarritoRepository : GenericRepository<Carrito>, IProductCarritoRepository
    {
        private readonly ApplicationContext _db;
        public ProductCarritoRepository(ApplicationContext db) : base(db)
        {
            _db = db;
        }
    }
